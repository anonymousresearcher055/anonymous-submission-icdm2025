...
results = {
    ...
    'red modularity-2': [],
    'blue modularity-2': [],
    'fairness_modularity-1': [],
    'fairness_modularity-2': [],
    'diversity-1': [],
    'diversity-2': [],
    'fair_modularity_percentage': [],
    'fairness_modularity_percentage': [],
    'Balance': [],
    'Red Balance': [],
    'Blue Balance': []
}     
...
for file_path in datasets:
    ...
    #add the results for the diversity gain threshold louvain method
